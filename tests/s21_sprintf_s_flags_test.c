...
START_TEST(test_s21_sprintf_many_strings_with_null) {
  char original[100];
  char my[100];
  char *null_str = S21_NULL;
  ck_assert_int_eq(s21_sprintf(my, "%-1.1s. %-14.17s.", null_str, null_str),
...
START_TEST(test_s21_sprintf_null_string_with_precision) {
  ...
  char my[100];
  char *null_str = NULL;
  ck_assert_int_eq(s21_sprintf(my, "%.8s", null_str),
...
START_TEST(test_s21_sprintf_many_strings_with_null_with_precision) {
  ...
  char my[100];
  char *null_str = NULL;
  ck_assert_int_eq(s21_sprintf(my, "%.0s. %.1s. %.5s %.6s", null_str, null_str,
                               null_str, null_str),
...
START_TEST(
  ...
  char my[100];
  char *null_str = NULL;
  ck_assert_int_eq(s21_sprintf(my, "%-.0s. %-.1s. %-.5s %-.6s", null_str,
                               null_str, null_str, null_str),
                   sprintf(original, "%-.0s. %-.1s. %-.5s %-.6s", null_str,
                           null_str, null_str, null_str));
  ck_assert_str_eq(my, original);
