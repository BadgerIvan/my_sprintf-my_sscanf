...
static int get_sign(const char **str, my_size_t *width) {
  int sign = 1;
  if (**str == '-') {
    sign = -1;
    (*str)++;
...
static int parse_unsigned_long_with_width(const char **str, my_size_t width,
                                          unsigned long *value) {
  int flag = 0;
  *value = 0;
  width = width ? width : (my_size_t)-1;
...
static int parse_long_with_width(const char **str, my_size_t width,
                                 long *value) {
  int flag = 0;
  *value = 0;
  width = width ? width : (my_size_t)-1;
...
static int process_char(const char **str, info_t *info_flag, va_list args,
  ...
  my_size_t width = info_flag->width ? info_flag->width : 1;
  my_size_t i;
...
static int process_string(const char **str, info_t *info_flag, va_list args,
  ...
  my_size_t width = info_flag->width ? info_flag->width : (my_size_t)-1;
  my_size_t i;
...
static int parse_nan_inf(const char **str, my_size_t width, int sign,
                         long double *value) {
  int flag = 0;
  if (width >= 3) {
...
static int parse_long_double_from_string(const char **str, my_size_t width,
                                         long double *value) {
  int flag = 0;
  *value = 0;
  width = width ? width : (my_size_t)-1;
