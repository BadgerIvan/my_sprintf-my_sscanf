...
void long_double_to_scientific(char *str, long double num, my_size_t precision);
void long_double_to_string_auto(char *str, long double num, my_size_t presicion,
                                int hash_flag);
